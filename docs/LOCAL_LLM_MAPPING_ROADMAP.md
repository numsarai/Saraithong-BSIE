...
- ultra-fast fallback / lightweight triage candidate:
  - `gemma4:e2b`
- higher-quality Gemma candidate สำหรับ synthetic mapping/OCR fixture test รอบถัดไป:
  - `gemma4:26b`
...
- smoke benchmark นี้ยังวัดแค่ JSON compliance/latency; ก่อนเปลี่ยน default ควรทดสอบกับ synthetic bank-header และ document-layout fixtures
