...
- หลังเพิ่ม first-class `direction_marker` amount path แล้ว `gemma4:26b` rerun ชุด 8-bank ได้ `54/55` ทั้ง text/vision และ validation ผ่านทุก fixture เหลือ miss เดิมเฉพาะ TTB balance ambiguity
