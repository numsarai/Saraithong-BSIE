...
describe('BulkIntake', () => {
  ...
  it('submits a folder path and renders the returned case summary', async () => {
    ...
    expect(screen.getByText('Short guidance for this case')).toBeInTheDocument()
    expect(screen.getByText(/view as chronological before concluding balance errors/i)).toBeInTheDocument()
