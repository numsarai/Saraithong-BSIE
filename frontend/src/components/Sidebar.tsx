    ...
    <aside className="w-[210px] shrink-0 bg-surface border-r border-border sticky top-0 h-screen py-6 px-3 flex flex-col gap-1">
      ...
      <div className="mt-auto pt-4 border-t border-border">
        <a
          href="/bank-manager"
          className={cn(
            'flex items-center gap-2.5 px-2.5 py-2 rounded-lg transition-all text-[13px] text-muted hover:text-accent hover:bg-accent/[0.08]',
            window.location.pathname === '/bank-manager' && 'bg-accent/[0.13] text-accent font-semibold',
          )}
        >
